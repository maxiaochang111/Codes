...
x = torch.rand((batch_size, input_dim, num_steps, num_nodes))

adj = torch.randint(0, 2, (batch_size, num_steps, num_nodes, num_nodes)).float()

gat_model = GATBlock(input_dim, out_channels=64)

output_x_prime = gat_model(x, adj)

print("Input x shape:", x.shape)
print("Adjacency matrix shape:", adj.shape)
print("Output x' shape:", output_x_prime.shape)
